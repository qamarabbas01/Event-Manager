			...
			<section class="hidden lg:block">
				<div class="max-w-lg">
					...
					<p class="mt-4 text-lg text-gray-600">
						Get a demo dashboard with event management, attendee insights, and analytics.
					</p>

					<div class="mt-8 grid grid-cols-1 gap-4">
						<div class="rounded-2xl border border-gray-200 bg-white/70 backdrop-blur p-5 shadow-sm">
							<p class="text-sm font-semibold text-gray-900">No setup required</p>
							<p class="mt-1 text-sm text-gray-600">
								Account data is stored locally so you can explore the app instantly.
							</p>
						</div>
						<div class="rounded-2xl border border-gray-200 bg-white/70 backdrop-blur p-5 shadow-sm">
							<p class="text-sm font-semibold text-gray-900">Designed for organizers</p>
							<p class="mt-1 text-sm text-gray-600">
								Track bookings and revenue with a clean, responsive UI.
							</p>
						</div>
					</div>
				</div>
